...
public class HotFeedFragment extends PostBtnAnimFragment<FeedListPresenter> {
	...
	private Listeners.OnResultListener mListener = new Listeners.OnResultListener() {
		...
		public void onResult(int nums) {
			...
			if (nums <= 0) {
				mTipView.setText(ResFinder
						.getString("umeng_comm_no_newfeed_tips"));
			} else {
	...
	/**
	 * 
	 * 隐藏[更新N条feed]的View。注意：该方法必须由{@link #showNewFeedTips}
	 * 的AnimationListener回调中被调用</br>
	 */
	...
	public void initAdapter() {
		...
		mTipView = (TextView) headerView.findViewById(ResFinder
				.getId("umeng_comm_feeds_tips"));
	...
	public void initSwitchView() {
		...
		button1 = (TextView) headerView.findViewById(ResFinder
				.getId("umeng_switch_button_one"));
		button2 = (TextView) headerView.findViewById(ResFinder
				.getId("umeng_switch_button_two"));
		button3 = (TextView) headerView.findViewById(ResFinder
				.getId("umeng_switch_button_three"));
		button4 = (TextView) headerView.findViewById(ResFinder
				.getId("umeng_switch_button_four"));
