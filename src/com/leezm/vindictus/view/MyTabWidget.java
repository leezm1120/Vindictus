package com.leezm.vindictus.view;
...
import com.leezm.vindictus.exception.CustomException;
...
public class MyTabWidget extends LinearLayout {
	...
	private int[] mDrawableIds = new int[] { R.drawable.bg_zixun,
//			R.drawable.bg_gonggao,
			R.drawable.bg_video,
//			R.drawable.bg_manual,
			R.drawable.bg_shequu,
//			R.drawable.bg_simulation,
			R.drawable.bg_found,
	...
	//	this.setBackgroundColor(Color.rgb(255, 0, 0));
		...
		for (int i = 0; i < size; i++) {
			...
			if (i == 0) {
				...
				itemName.setTextColor(Color.rgb(0, 157, 220));
	...
	public void setTabsDisplay(Context context, int index) {
		...
		for (int i = 0; i < size; i++) {
			...
			if ((Integer) (checkedTextView.getTag()) == index) {
				...
				checkedTextView.setTextColor(Color.rgb(0, 157, 220));
				mViewList.get(i).setBackgroundColor(Color.rgb(100, 100, 100));
			} else {
