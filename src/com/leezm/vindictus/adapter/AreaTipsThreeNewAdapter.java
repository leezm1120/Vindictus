...
public class AreaTipsThreeNewAdapter extends BaseAdapter {

	private Context context;
	private List<AreaTipsBean> list;

	public AreaTipsThreeNewAdapter(Context context, List list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String battle = list.get(position).getMapName();
